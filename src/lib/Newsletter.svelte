...
<div
  class="h-10 max-w-[357px] bg-cr-light dark:bg-cr-black-200 rounded-md flex items-center justify-between border border-cr-grey-200 dark:border-cr-black-200"
>
  <input
    type="text"
